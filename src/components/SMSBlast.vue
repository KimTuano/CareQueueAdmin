  ...
  methods: {
    ...
    async pollPermissions() {
      ...
      try {
        ...
        const res = await fetch(`https://carequeue-admin.com/api/doctor-permissions/${user.doctor_id}`)
        const data = await res.json()
        const updated = {}
    ...
    async sendBlast() {
      ...
      try {
        ...
        const res  = await fetch('https://carequeue-admin.com/api/sms-blast', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    async fetchPatients() {
      ...
      try {
        const res = await fetch('https://carequeue-admin.com/api/patients')
    ...
    async fetchHistory() {
      try {
        const res = await fetch('https://carequeue-admin.com/api/sms-blast/history')
