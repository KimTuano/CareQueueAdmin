...
export default {
  ...
  methods: {
    ...
    async fetchWaitingCount() {
      try {
        const res = await fetch('https://carequeue-admin.com/api/appointments')
    ...
    async selectDoctor(doc) {
      ...
      try {
        const res = await fetch(
          `https://carequeue-admin.com/api/doctor-permissions/${doc.id}`
        )
    ...
    async savePermissions() {
      ...
      try {
        const res = await fetch(
          `https://carequeue-admin.com/api/doctor-permissions/${this.selectedDoctor.id}`,
          {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
